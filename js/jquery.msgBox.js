...
function msg (options) {
    ...
    var divTitle = "<div class=\"msgBoxTitle\"><div id=" + divMsgBoxImageId + " class=\"msgBoxImage\"><img src=\"" + msgBoxImagePath + image + "\"/></div>" + options.title + "</div>";
